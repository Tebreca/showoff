...
public class Translator {
    ...
    public static String translate(String s) {
        ...
        if (!s.contains("\s")) {
            return translate(s, s.toLowerCase().chars().mapToObj(i -> String.valueOf((char) i)).filter(vowels::contains).findFirst().orElse("a"));
